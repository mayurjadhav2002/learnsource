...
function SoftwareCards({ data }: { data: SoftwareCards }) {
...
<Image
            ...
            <p className="font-bold text-large text-center">
              <span className='text-green-600 m-1'>{data.price}</span>
              <span className='text-red-600 line-through  m-1'>{data.price_before}</span>


            </p>

            <h4 className="font-bold text-large text-center pb-2">{data.title}</h4>

            <div className='w-full'>
              <div className="px-5 py-2 items-center flex justify-between bg-slate-50">
                ...
                <div className='flex justify-start'>
                  ...
                  <div
                    ...
                    <span className="flex-1 ml-1 text-sm  text-green-500 whitespace-nowrap">{data.posted_on}</span>
                  </div>
                ...
                <div
                >
                  <p className="text-tiny uppercase font-bold">{data.brand}</p>
